...
public class DepotAuto extends SequentialCommandGroup{
   ...
   private static final double AUTO_SPEED_MPS =
    ...
    public DepotAuto(IntakeSubsystem intakeSubsystem,CommandSwerveDrivetrain drivetrain){
        ...
        //theoretically, if distances were arbitrary, this would work perfectly
        addCommands(
            ...
            //instead of this, we could check and move to april tag 9 (red) or april tag 25 (blue)
            drivetrain.applyRequest(() ->
                drive.withVelocityX(AUTO_SPEED_MPS)
                    .withVelocityY(0.0)
                    .withRotationalRate(0.0)
            ).withTimeout(4.0),//temp value
